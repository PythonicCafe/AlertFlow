...
AIRFLOW_PSQL_USER_MAIN=${PSQL_USER_MAIN}
AIRFLOW_PSQL_PASSWORD_MAIN=${PSQL_PASSWORD_MAIN}
AIRFLOW_PSQL_HOST_MAIN=${PSQL_HOST_MAIN}
AIRFLOW_PSQL_PORT_MAIN=${PSQL_PORT_MAIN}
AIRFLOW_PSQL_DB_MAIN=${PSQL_DB_MAIN}
AIRFLOW_PSQL_URI_MAIN=postgresql://${PSQL_USER_MAIN}:${PSQL_PASSWORD_MAIN}@${PSQL_HOST_MAIN}:${PSQL_PORT_MAIN}/${PSQL_DB_MAIN}
